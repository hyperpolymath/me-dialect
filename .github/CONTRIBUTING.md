...
# Contributing — me-dialect

## Audience

Developers working **on** `me-dialect`. For consumers (people calling or
...
``` bash
git clone git@github.com:hyperpolymath/me-dialect.git
cd me-dialect
...
- Bugs in `me-dialect`: file at `hyperpolymath/me-dialect/issues`.
