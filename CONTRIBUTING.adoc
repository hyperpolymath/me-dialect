...
git clone https://github.com/hyperpolymath/me-dialect-playground.git cd
...
toolbox create me-dialect-playground-dev toolbox enter
me-dialect-playground-dev # Install dependencies manually
...
me-dialect-playground/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
